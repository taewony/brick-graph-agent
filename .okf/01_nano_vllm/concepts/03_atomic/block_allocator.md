...
## 📌 개념 정의
**Block Allocator**는 [`memory_pool`](memory_pool.md)에서 미리 할당된 고정‑크기 메모리 블록을 **시점‑기반**으로 가져오고 반환하는
책임을 진다.
...
## 🔗 관련 관계
- **PREREQUISITES**: [`memory_pool`](memory_pool.md)
- **PREREQUISITE_OF**: [`swap_manager`](swap_manager.md) (스와핑 지원)